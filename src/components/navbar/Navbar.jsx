            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  <Link to={'/entertainment'} className="text-sm font-medium text-gray-900 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                  Entertainment
                  </Link>
                  ...
                  {user?.user?.email === "rajuchatterjeeofficial@gmail.com" ? <div className="flow-root">
                  ...
                  <div className="flow-root">
                    <Link to={'/'} className="-m-2 block p-2 font-medium text-gray-900 cursor-pointer">
                      <img
                        ...
                        src="https://sarmoneypoint.in/wp-content/uploads/2023/09/Tester.png"
                        alt="profile mobile" />                                        </Link>
                  </div>
                </div>
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  ...
                  <Link to={'/entertainment'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                  Entertainment
                  </Link>
                 {user ?  <Link to={'/order'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                  ...
                  {user?.user?.email === 'rajuchatterjeeofficial@gmail.com' ? 
